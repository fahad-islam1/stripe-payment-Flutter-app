...
import 'package:stripe_method_flutter/service/stripe_payment.dart';
import 'package:stripe_method_flutter/widgets/resuable_textfield.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Donation for Hospital'),
      ),
